...
from utils import hat_so3, vee_so3
...
class ControllerLee():
    ...
    def computeDesiredRot(Fd, yaw):
        ...
        ydes_mask = normZX > 0
        # print(ydes_mask.shape, normZX[ydes_mask].shape, torch.cross(zdes, xcdes, dim=-2)[ydes_mask].shape)
        ydes[ydes_mask] = torch.cross(zdes, xcdes, dim=-2)[ydes_mask] / normZX[ydes_mask, None,None]
